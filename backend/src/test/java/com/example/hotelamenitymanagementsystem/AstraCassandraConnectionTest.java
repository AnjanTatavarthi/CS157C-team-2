package com.example.hotelamenitymanagementsystem;
...
public class AstraCassandraConnectionTest {

    /**
     * Logger for the class.
     */
    private static Logger LOGGER = LoggerFactory.getLogger(AstraCassandraConnectionTest.class);
