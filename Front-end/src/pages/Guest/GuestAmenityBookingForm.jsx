...
function GuestAmenityBookingForm() {
    ...
    const createBooking = (event) => {
        ...
        backend.post('/amenityBookings', {
            ...
            navigate(`/guest/amenities/booking-confirmation/${response.data.bookingId}`, {replace: true});
        }).catch(() => {
        });
    };
...
export default GuestAmenityBookingForm;
